...
/**
 * REST controller for managing {@link com.delaiglesia.italogenealogy.domain.Certificate}.
 */
@RestController
@RequestMapping("/api")
public class CertificateResource {
    ...
    public ResponseEntity<List<CertificateDTO>> getAllCertificates(
        ...
        Page<CertificateDTO> page;
        if (eagerload) {
            page = certificateService.findAllWithEagerRelationships(pageable);
        } else {
            page = certificateService.findAll(pageable);
        }
